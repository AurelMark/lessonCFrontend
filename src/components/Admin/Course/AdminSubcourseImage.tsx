...
import { SubcourseForm } from "@/validation/course";

type TAdminSubcourseImageProps = {
  form: UseFormReturn<SubcourseForm>;
  setSelectedFile: (file: File) => void;
  isPending: boolean;
  selectedFile: File | null;
};

export function AdminSubcourseImage({
  form,
  setSelectedFile,
  isPending,
  selectedFile,
}: TAdminSubcourseImageProps) {
